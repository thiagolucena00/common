...
namespace common.Dependency.Scoped
{
    public class ScopedIocResolver : IScopedIocResolver
    {
        ...
        {
            return (T) Resolve(key, typeof(T), argumentsAsAnonymousType);
        }
        ...
        {
            var resolvedObject = argumentsAsAnonymousType != null
                ? _iocResolver.Resolve(key, type, argumentsAsAnonymousType)
                : _iocResolver.Resolve(key, type);
        ...
        {
            return _iocResolver.IsRegistered(key);
        }
